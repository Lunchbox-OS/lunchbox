...
<.github/workflows/ci.yml> and <docs/INSTALL.md> describes exact environment setup, especially if coming from Ubuntu 24.04 (Lunchbox requires 26.04).
...
`SHEPHERD_*`, `com.armeafamily.shepherd.*`) and were deliberately left that way.
<docs/ai/history/README.md> has a translation table; the rename itself is
<docs/ai/history/2026-09-19 003 shepherd-to-lunchbox-rename.md>.

...
object RpcMethods {
    ...
    const val WIFI_SCAN: String = "wifi_scan"
    const val WIFI_NETWORKS: String = "wifi_networks"
    const val WIFI_SAVED_NETWORKS: String = "wifi_saved_networks"
    const val WIFI_SAVE: String = "wifi_save"
    const val WIFI_CONNECT: String = "wifi_connect"
    const val WIFI_FORGET: String = "wifi_forget"

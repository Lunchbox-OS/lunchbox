package com.lunchbox_os.companion.ui.settings
...
import com.lunchbox_os.companion.R
        ...
        Column(
            ...
            Card(Modifier.fillMaxWidth()) {
                Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Text("Lunchbox Companion $version", style = MaterialTheme.typography.bodyMedium)
                    TextButton(onClick = {

package com.lunchbox_os.companion.ui.home
...
import com.lunchbox_os.companion.ui.components.LinkBanner
import com.lunchbox_os.companion.ui.components.ReasonLines
import com.lunchbox_os.companion.ui.components.StatusBadge
...
fun HomeScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(state.record?.displayName ?: "Lunchbox") },
                actions = {

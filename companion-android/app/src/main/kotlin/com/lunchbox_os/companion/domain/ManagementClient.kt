...
/**
 * Typed façade over [DeviceConnection], mirroring the device's
 ...
 * surface as [com.lunchbox_os.companion.ble.RpcException].
 *
 ...
 */
class ManagementClient(private val connection: DeviceConnection) {
    ...
    private inline fun <reified T> decode(element: JsonElement): T =
        LunchboxJson.decodeFromJsonElement(kotlinx.serialization.serializer(), element)

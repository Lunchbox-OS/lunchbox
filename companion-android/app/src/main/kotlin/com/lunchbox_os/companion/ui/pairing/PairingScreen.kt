package com.lunchbox_os.companion.ui.pairing
...
import com.lunchbox_os.companion.ble.DiscoveredDevice
import com.lunchbox_os.companion.ui.PairingPhase
                ...
                items(discovered.values.sortedByDescending { it.rssi }, key = { it.identifier }) { device ->
                    Card(
                        ...
                        ListItem(
                            ...
                            headlineContent = { Text(device.name ?: "lunchbox") },
                            supportingContent = {
                ...
                Column(
                    ...
                    Text(
                        "${phase.deviceName ?: "This device"} already has an administrator. " +
                            "Approve this code under Administrators — either in the Lunchbox " +

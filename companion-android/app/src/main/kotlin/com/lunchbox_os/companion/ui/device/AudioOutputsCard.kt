package com.lunchbox_os.companion.ui.device
...
import com.lunchbox_os.companion.domain.AudioOutputKind
 ...
 */
@Composable
fun AudioOutputsCard(outputs: List<AudioOutputRecord>, busy: Boolean, vm: DeviceViewModel) {
...
@Composable
private fun OutputRow(record: AudioOutputRecord, busy: Boolean, vm: DeviceViewModel) {

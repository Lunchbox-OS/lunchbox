...
//!
//! The cache itself lives in `shepherd-media-cache`, which shepherdd shares
...
//!
//! Nothing here waits on a download. When shepherdd is prefetching the same
...
use shepherd_media_cache::{VideoCache, source_url};

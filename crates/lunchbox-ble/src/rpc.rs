//! BLE glue over `lunchbox_management::dispatch_json`.
//!
...
use lunchbox_management::{ManagementService, RpcDispatchError, dispatch_json};
...
mod tests {
    ...
    //! `lunchbox-management/tests/dispatch.rs`; the `ManagementError` →

...
//!
//! Three things live here, and they are here rather than in `lunchbox-http`
...
impl Default for WebAuthPolicy {
    ...
    fn default() -> Self {
        Self {
            session_idle: lunchbox_config::DEFAULT_SESSION_IDLE,
            session_max_age: lunchbox_config::DEFAULT_SESSION_MAX_AGE,
            lockout_after: lunchbox_config::DEFAULT_LOCKOUT_AFTER,
            lockout: lunchbox_config::DEFAULT_LOCKOUT,
        }
    }
}
...
impl WebAuth {
    ...
    ///
    /// The recovery path: `lunchboxd`'s reset sentinel, or an operator over
...
mod tests {
    use super::*;
    use lunchbox_util::LocalProtectedFiles;

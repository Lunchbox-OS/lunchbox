...
//! reads it. Lives in this crate rather than in `lunchbox-http` because
//! `lunchbox-http` depends on *this* one: the other direction is a cycle.

use std::net::SocketAddr;
use std::sync::{Arc, RwLock};

use lunchbox_api::{WebListenerState, WebListenerView};

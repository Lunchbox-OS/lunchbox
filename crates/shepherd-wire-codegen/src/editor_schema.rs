...
//!
//! `shepherd-config-wasm` hands the editor three JSON payloads: the `RawConfig`
...
#[allow(dead_code)]
struct EditorTypes {
    report: shepherd_config_wasm::report::Report,
    issue: shepherd_config_wasm::report::Issue,

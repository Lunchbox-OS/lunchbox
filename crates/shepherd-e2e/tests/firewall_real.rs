...
//!
//! This is the real thing: a `shepherdd` boots, an activity is launched
//! through the privileged `shepherd-firewall-helper`, and a probe inside
...
"#,
    ...
    assert!(
        ...
        "expected external connection to be dropped by the firewall. \
         ...
         check that shepherdd reports `firewall_enforcement_status() == Supported` \

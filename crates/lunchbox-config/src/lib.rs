//! Configuration parsing and validation for lunchboxd
//!
...
mod tests {
    ...
    /// variable: lunchboxd has to be able to hand the same number to the
...
"#,
    ...
    use super::*;
    use lunchbox_api::InputCompatMode;
    ...
    fn cooldown_grace_service_default_and_per_subject_overrides() {
        ...
        let grace = |id: &str| {
            policy
                .get_entry(&lunchbox_util::EntryId::new(id))
                .unwrap()
                .limits

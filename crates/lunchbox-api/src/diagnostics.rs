...
/// (`lunchbox_ble::protocol::MAX_FRAME_BYTES`). An unbounded list here is the
...
/// all sit in crates that know nothing about lunchboxd's registry. They take

...
//!
//! One arm per [`lunchbox_state_proto::StateRequest`] variant, and nothing else:
...
//! limit *means* stays in `lunchbox-core`, inside lunchboxd.
//!
...
use lunchbox_store::{Store, StoreError};

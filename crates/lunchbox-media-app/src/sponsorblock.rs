...
//! directory to keep files in. The Linux binary and lunchboxd cache under
...
//! verbatim. Nothing is re-encoded: `lunchbox_media_core::sponsorblock` owns the
...
/// directory on Linux — lunchboxd's prefetcher warms buckets while a player

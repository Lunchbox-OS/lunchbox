...
//!
//! This is the state the Linux binary never needs (because `lunchboxd` passes a
...
pub struct LibraryEntry {
    ...
    /// Linux binary's `--sponsorblock-categories`, which lunchboxd fills in from
...
/// playlist URL. Resolving a variant into a `lunchbox_media_core::Library`

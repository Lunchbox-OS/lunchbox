...
//! [`shepherd_api::DiagnosticCode::CompositorUnreachable`] instead of looking
...
///
/// Idempotent, because a second shepherdd in the same session would otherwise
...
/// process outside shepherd's supervision *and* outside the cgroup the

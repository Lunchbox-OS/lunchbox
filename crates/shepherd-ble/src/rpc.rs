...
mod tests {
    ...
    use shepherd_api::{
        ...
        ServiceStateSnapshot, SessionInfo, UsageStat, VolumeInfo, VolumeRestrictions, WindowInfo,
    };
    use shepherd_management::{LaunchOutcome, ManagementError, ManagementResult};
    use tokio::sync::broadcast;

    /// Minimal mock that records calls and returns canned responses.
    struct MockSvc {
        health_calls: tokio::sync::Mutex<u32>,
    }
    ...
    fn req(id: u32, method: &str, params: serde_json::Value) -> RpcRequest {
        RpcRequest {
            id,

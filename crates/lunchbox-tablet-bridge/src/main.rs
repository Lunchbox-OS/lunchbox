//! lunchbox-tablet-bridge: translate absolute pointer / tablet input into
//! synthetic touch events.
//!
//! The inverse of lunchbox-touch-bridge. Run it alongside an activity that

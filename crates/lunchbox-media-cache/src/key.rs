//! Cache keys.
//!
//! The key derivation itself is `lunchbox_media_app::cache_key`, shared with
...
//! `lunchbox_media_core::Source` into the URL those keys hash. The shared crate
//! knows nothing about library sources.

pub use lunchbox_media_app::cache_key::{content_key, interest_key};

use lunchbox_media_core::{ClassifiedUri, Source};
...
mod tests {
    use super::*;
    use lunchbox_media_core::PlayerHint;

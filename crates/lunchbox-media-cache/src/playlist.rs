...
//!
//! Lives beside the video cache because lunchboxd needs it too: to prefetch a
...
// `lunchbox-media-core` (`parse_flat_playlist`), shared with the Android app.
...
/// `docs/lunchbox-media.md` for setup instructions.
...
///
/// lunchboxd checks this at startup to warn when a library references YouTube

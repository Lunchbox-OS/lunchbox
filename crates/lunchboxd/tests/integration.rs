//! Integration tests for lunchboxd
//!
//! These tests verify the end-to-end behavior of lunchboxd.

use lunchbox_api::{EntryKind, WarningSeverity, WarningThreshold};
use lunchbox_config::{AvailabilityPolicy, Entry, LimitsPolicy, Policy, load_config};
use lunchbox_core::{CoreEngine, CoreEvent, LaunchDecision};
use lunchbox_host_api::{HostCapabilities, MockHost};
use lunchbox_store::{SqliteStore, Store};
use lunchbox_util::{self, EntryId, MonotonicInstant};
...
async fn test_mock_host_integration() {
    use lunchbox_host_api::{HostAdapter, SpawnOptions};
...
fn test_config_parsing() {
    use lunchbox_config::parse_config;

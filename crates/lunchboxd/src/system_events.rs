...
//!
//! Signals watched (both on the system bus, which lunchboxd can read from
...
/// How long lunchboxd holds the logind delay inhibitor after emitting
...
pub fn spawn_system_event_watchers(
    ...
    tokio::spawn(async move {
        loop {
            ...
            // it is gone lunchboxd is shutting down and there is no reason to
            // keep retrying.

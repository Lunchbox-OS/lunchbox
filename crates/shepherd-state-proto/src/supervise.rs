...
//!
//! An activity runs as the kiosk uid, and so does `shepherdd`. Signal
...
//! accounting, no bedtime, and no audit. #161 made a shepherdd that *exits*
...
//!
//! [`Supervision::beat`] is called from shepherdd's 100 ms tick, the same loop
...
//! the property anyone wants from a watchdog: a shepherdd whose engine has
            ...
            loop {
                ...
                match stream.beat() {
                    ...
                    Err(e) => {
                        ...
                        // restarted, and shepherdd is plainly still alive. The

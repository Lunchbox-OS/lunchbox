...
//! cgroups and a session and is covered in `shepherd-ipc` and on a device.
...
use shepherd_state_proto::{RemoteStore, StateRequest, server};
use shepherd_store::{
...
fn spawn_server(
    socket: PathBuf,
    store: Arc<dyn Store>,
    files: Arc<dyn shepherd_util::ProtectedFiles>,
...
fn fixture() -> Fixture {
    ...
    let db = dir.path().join("shepherdd.db");
...
impl Store for FailingStore {
    fn append_audit(&self, _: AuditEvent) -> shepherd_store::StoreResult<()> {
        fail!()
    }
    fn get_recent_audits(&self, _: usize) -> shepherd_store::StoreResult<Vec<AuditEvent>> {
        fail!()
    }
    fn get_usage(&self, _: &EntryId, _: NaiveDate) -> shepherd_store::StoreResult<Duration> {
        fail!()
    }
    fn add_usage(&self, _: &EntryId, _: NaiveDate, _: Duration) -> shepherd_store::StoreResult<()> {
        fail!()
    }
    fn get_token_state(
        &self,
    ...
    fn get_cooldown_until(
        &self,
        _: &LimitSubject,
    ) -> shepherd_store::StoreResult<Option<chrono::DateTime<Local>>> {
        fail!()
    }
    ...
    fn clear_cooldown(&self, _: &LimitSubject) -> shepherd_store::StoreResult<()> {
        fail!()
    }
    fn load_snapshot(&self) -> shepherd_store::StoreResult<Option<StateSnapshot>> {
        fail!()
    }
    fn save_snapshot(&self, _: &StateSnapshot) -> shepherd_store::StoreResult<()> {
        fail!()
    }
    ...
    fn get_daily_override(
        ...
        _: &LimitSubject,
        _: NaiveDate,
    ) -> shepherd_store::StoreResult<Option<shepherd_api::DailyOverride>> {
        fail!()
    }
    fn upsert_daily_override(
        ...
        _: Option<bool>,
        _: Option<i64>,
    ) -> shepherd_store::StoreResult<shepherd_api::DailyOverride> {
        fail!()
    }
    fn clear_daily_override(
        ...
        _: &LimitSubject,
        _: NaiveDate,
    ) -> shepherd_store::StoreResult<bool> {
        fail!()
    }
    fn list_daily_overrides(
        &self,
        _: NaiveDate,
    ) -> shepherd_store::StoreResult<Vec<shepherd_api::DailyOverride>> {
        fail!()
    }
    fn record_audio_output_seen(
        &self,
        _: &shepherd_api::AudioOutput,
    ) -> shepherd_store::StoreResult<()> {
        fail!()
    }
    ...
    fn get_audio_output(
        &self,
        _: &str,
    ) -> shepherd_store::StoreResult<Option<shepherd_api::AudioOutputRecord>> {
        fail!()
    }
    fn list_audio_outputs(
        &self,
    ) -> shepherd_store::StoreResult<Vec<shepherd_api::AudioOutputRecord>> {
        fail!()
    }
    fn forget_audio_output(&self, _: &str) -> shepherd_store::StoreResult<bool> {
        fail!()
    }
    fn get_setting(&self, _: &str) -> shepherd_store::StoreResult<Option<String>> {
        fail!()
    }
    fn set_setting(&self, _: &str, _: &str) -> shepherd_store::StoreResult<()> {
        fail!()
    }
    fn get_usage_range(
        &self,
        ...
        _: NaiveDate,
        _: NaiveDate,
    ) -> shepherd_store::StoreResult<Vec<(NaiveDate, Duration)>> {
        fail!()
    }
    fn get_all_usage_for_date(
        &self,
        _: NaiveDate,
    ) -> shepherd_store::StoreResult<Vec<(EntryId, Duration)>> {
        fail!()
    }
}
...
fn every_remaining_method_is_wired_to_the_right_store_call() {
    ...
    let output = shepherd_api::AudioOutput {
        key: "alsa:hdmi".into(),
...
fn the_protected_files_round_trip_and_take_is_atomic() {
    use shepherd_state_proto::RemoteFiles;
    ...
    // shepherdd falls back to its own copy on `None`, and an error there would

...
# Emit the `dpkg-maintscript-helper rm_conffile` calls that retire the two
# conffiles issue #177 moved out of the admin directories.
#
...
EOF
    ...
    # each of the four files that used to be listed had a reason not to be:
    #
    ...
    #       intends, with a same-named file in /etc that is read first.
    #
